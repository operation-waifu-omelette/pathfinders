local Dazzle =
{
	...
	{
		 description = "pf_bad_juju_cooldown_reduction",
	...
	{
		 description = "pf_bad_juju_armor_reduction",
		 ability_name = "pf_bad_juju",
	...
	{
		 description = "pf_bad_juju_max_reduction",
		 ability_name = "pf_bad_juju",
		 special_value_name = "max_reduction",
		 operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		 value = 2,
	},

	{
		 description = "pf_bad_juju_radius",
		 ability_name = "pf_bad_juju",
	...
	{
		 description = "pf_bad_juju_duration",
		 ability_name = "pf_bad_juju",
		 special_value_name = "duration",
		 operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		 value = 1.5,
