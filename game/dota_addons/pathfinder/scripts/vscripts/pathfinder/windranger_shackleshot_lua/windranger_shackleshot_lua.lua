...
LinkLuaModifier( "modifier_shackle_stun", "pathfinder/windranger_shackleshot_lua/modifier_shackle_stun", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_windranger_shackleshot_armour", "pathfinder/windranger_shackleshot_lua/windranger_shackleshot_lua", LUA_MODIFIER_MOTION_NONE )
