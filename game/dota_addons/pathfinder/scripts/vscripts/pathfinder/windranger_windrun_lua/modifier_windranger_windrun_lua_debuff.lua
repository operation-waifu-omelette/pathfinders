...
function modifier_windranger_windrun_lua_debuff:CheckState() 
	local in_air = self:GetParent():HasModifier("modifier_eul_cyclone")

	local state = {
		[MODIFIER_STATE_UNSELECTABLE] = in_air,        
		[MODIFIER_STATE_NO_HEALTH_BAR] = in_air,
		[MODIFIER_STATE_NO_UNIT_COLLISION] = in_air,
	}
