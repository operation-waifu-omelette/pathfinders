...
function modifier_dawnbreaker_celestial_hammer_lua_attach_trail:IsHidden()
	return true
end

function modifier_dawnbreaker_celestial_hammer_lua_attach_trail:IsDebuff()
	return true
end

function modifier_dawnbreaker_celestial_hammer_lua_attach_trail:IsPurgable()
	return true
end
