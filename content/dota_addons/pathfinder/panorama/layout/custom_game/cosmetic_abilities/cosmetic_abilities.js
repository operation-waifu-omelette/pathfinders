...
(function () {
	...
	const layout = `
		<root>
			<styles>
				<include src="s2r://panorama/layout/custom_game/styles/dotau_styles.vcss_c" />
			</styles>
			<Panel></Panel>
		</root>
	`;

	FindDotaHudElement("buffs").BLoadLayoutFromString(layout, true, false);
	FindDotaHudElement("buffs").AddClass("buffs_chc");

	FindDotaHudElement("debuffs").BLoadLayoutFromString(layout, true, false);
	FindDotaHudElement("debuffs").AddClass("debuffs_chc");
