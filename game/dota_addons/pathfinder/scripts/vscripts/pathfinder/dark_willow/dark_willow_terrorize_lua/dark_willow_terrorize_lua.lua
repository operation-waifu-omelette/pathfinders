...
LinkLuaModifier( "modifier_wisp_ambient", "pathfinder/dark_willow/dark_willow_terrorize_lua/modifier_wisp_ambient", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dark_willow_terrorize_lua", "pathfinder/dark_willow/dark_willow_terrorize_lua/modifier_dark_willow_terrorize_lua", LUA_MODIFIER_MOTION_NONE )
...
function dark_willow_terrorize_lua:OnProjectileHit_ExtraData( target, location, ExtraData )
	...
	for _,enemy in pairs(enemies) do
		...
		-- summon skeletons and give them modifier
		if self:GetCaster():HasAbility("dark_willow_terrorize_lua_skeletons") then
			new_skeleton = CreateUnitByName("npc_dota_creature_dark_willow_skeleton_summon", enemy:GetOrigin(), true, nil, nil, DOTA_TEAM_GOODGUYS)
			new_skeleton:AddNewModifier(
				self:GetCaster(), -- player source
				self, -- ability source
