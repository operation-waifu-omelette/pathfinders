...
function modifier_ascension_armor:AddCustomTransmitterData( )
	return
	{
		flArmor = self.flArmor,		
	}
end

function modifier_ascension_armor:HandleCustomTransmitterData( data )
	self.flArmor = data.flArmor
end
