...
LinkLuaModifier( "modifier_pathfinder_dk_breathe_fire", "pathfinder/dragon_knight/breathe_fire", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_pathfinder_dk_macropyre_thinker", "pathfinder/dragon_knight/breathe_fire", LUA_MODIFIER_MOTION_NONE )
...
function modifier_pathfinder_dk_breathe_fire:IsHidden()
	return false
end

function modifier_pathfinder_dk_breathe_fire:IsDebuff()
	return true
end

function modifier_pathfinder_dk_breathe_fire:IsStunDebuff()
	return false
end

function modifier_pathfinder_dk_breathe_fire:IsPurgable()
	return true
end
...
function modifier_pathfinder_dk_breathe_fire:OnAttacked( params )
	if IsServer() then
		if self.record and self:GetCaster() == params.attacker then
			self.record = nil
