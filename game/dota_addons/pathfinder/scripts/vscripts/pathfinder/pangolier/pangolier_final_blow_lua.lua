...
pangolier_final_blow = pangolier_final_blow or class({})
...
function pangolier_final_blow:OnSpellStart()
	...
	caster:AddNewModifier(
		caster,
		self, 
		"modifier_pangolier_final_blow_impact_check", 
		{
			duration = dist/speed,
		}
	)
...
--[[---------------------------------------------------------------------
	PANGOLIER FINAL BLOW IMPACT CHECK MODIFIER
]]------------------------------------------------------------------------
...
--[[---------------------------------------------------------------------
	PANGOLIER FINAL BLOW MARKED MODIFIER
]]------------------------------------------------------------------------
