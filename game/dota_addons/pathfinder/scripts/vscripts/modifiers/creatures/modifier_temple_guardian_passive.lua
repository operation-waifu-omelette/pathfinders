...
function modifier_temple_guardian_passive:OnCreated( kv )
	if IsServer() then
		...
		self:GetParent():AddNewModifier(self:GetParent(), self, "modifier_treant_natures_guise_tree_walking", {})
		-- self:GetParent():AddNewModifier(self:GetParent(), self, "modifier_phased", {})
		self:GetParent():AddNewModifier(self:GetParent(), self, "modifier_item_gem_of_true_sight", {})
