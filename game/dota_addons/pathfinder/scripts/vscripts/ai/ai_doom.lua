...
function DoomThink()
	...
	if thisEntity.hDoomAbility and thisEntity.hDoomAbility:IsFullyCastable() and thisEntity:GetHealthPercent() < thisEntity.nDoomAbilityHealthPercentTrigger and #GetEnemyHeroesInRange( thisEntity, 9000 ) > 1 then
