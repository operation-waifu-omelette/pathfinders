...
function CAghanim:InitGameMode()
    ...
    GameRules:GetGameModeEntity():SetDefaultStickyItem("item_gem")
    ...
    GameRules:GetGameModeEntity():SetNeutralItemHideUndiscoveredEnabled(false)
    ...
    CustomGameEventManager:RegisterListener("pick_face", Dynamic_Wrap(CAghanim, "OnPickFace"))
    ...
    DOTA_SpawnMapAtPosition("background", Vector(-14336, -14336, 145), false, nil, nil, nil) -- was height 85
